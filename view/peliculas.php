...
<body onload="buscarTodos();">
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            <input type="hidden" class="btn btn-outline-success me-2" type="button">Main button</input>
            <button class="btn btn-outline-success me-2" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="limpiarCampos();">Agregar Pelicula</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form onsubmit="return false;" class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Portada</label>
                            <input type="file" class="form-control" id="portada">
                        </div>

                        <div class="col-md-6">
                            <label for="inputMarca" class="form-label">Genero</label>
                        ...
                        <div class="col-6">
                            <label for="inputAddress" class="form-label">Duracion</label>
                            <input type="text" class="form-control" id="duracion" step="any">
                        </div>

                        <div class="col-12">
                            <label for="inputAddress" class="form-label">Sinopsis</label>
                            <textarea class="form-control" aria-label="With textarea" id="sinopsis" style="height: 90px;"></textarea>
                        </div>
