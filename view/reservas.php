...
<body onload="buscarReservas();" class="bg-dark">
    <!-- Navigation-->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-black bg-info">
                    <h5 class="modal-title" id="staticBackdropLabel">Editar Reserva</h5>
                ...
                <div class="modal-body">
                    <form onsubmit="return false;" class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Reserva</label>
                        ...
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">IdPelicula</label>
                            <input type="text" class="form-control" id="idPelicula">
                        </div>

                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Cantidad Boletos</label>
                            <input type="number" class="form-control" id="boletos" step="any">
                        </div>

                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">IdUsuario</label>
                            <input type="text" class="form-control" id="idUsuario" step="any">
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="editarReservaId();">Guardar</button>
                </div>
            </div>
        </div>
